...
class User
  ...
  property :avater, String, default: '/avatars/default.png'
  ...
  property :facebook, String # Add this line
  property :x, String # Add this line
  ...
  property :quest, Text,
           default: '{"current":[false,false,false],"complete":[false,false,false],"conditions":[],"date":"2016-01-14 00:13:30 +0000"}'
  property :money, Integer, default: 50_000
  property :percent, Integer, default: 0

  # In-Game
  property :team, String, default: '["zGu","zKn","zYa"]'
  property :skill, Text,
           default: '{"s1":["31","32","34","4","10001"],"s2":["42","43","45","4","10005"],"s3":["52","53","54","4","10000"]}'
  property :items, Text, lazy: false, default: '{"c1": 3,"item":"c1"}'
  property :unlockskills, Text, lazy: false,
                                default: '{"1":0,"1":0,"4":0,"6":0,"7":0,"8":0,"31":0,"32":0,"34":0,"36":0,"37":0,"38":0,"42":0,"43":0,"45":0,"46":0,"47":0,"48":0,"52":0,"53":0,"54":0,"58":0,"59":0,"60":0,"61":0,"62":0,"63":0,"64":0,"65":0,"66":0,"67":0,"68":0,"69":0,"10000":0,"10005":0,"10001":0,"10003":0}'
  property :stats, Text, lazy: false,
                         default: '{"zGu": [1,0,0],"zKG": [1,0,0],"zKn": [1,0,0],"zPo": [1,0,0], "zYa": [1,0,0],"zTn": [1,0,0],"zYe": [1,0,0], "zCu": [1,0,0], "zKk": [1,0,0]}'
  property :unlockcharacters, Text, lazy: false,
                                    default: '{"zGu": 1,"zYa": 1,"zKn":1,"zPo":1,"zKG":1,"zTn":1,"zYe":1,"zCu":1,"zKk":1}'
...
class Friendship
  ...
  property :created_at, DateTime
  property :updated_at, DateTime # Make sure this line exists
...
class Forum
  ...
  property :avater, String, default: '/avatars/default1.jpg'
  property :post_count, Integer, default: 0
...
class Planet
  ...
  property :created_at, DateTime
  property :updated_at, DateTime
  property :avater, Text, default: '/avatars/box.png'
