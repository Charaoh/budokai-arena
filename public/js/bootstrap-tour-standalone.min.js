...
+ function(t) {
    ...
    o.VERSION = "3.2.0", o.DEFAULTS = {
        ...
        var u = l.left ? 2 * l.left - i + p : 2 * l.top - r + h,
            c = l.left ? "left" : "top",
            d = l.left ? "offsetWidth" : "offsetHeight";
...
function(t, e) {
    ...
    return n = e.document, o = function() {
        ...
        return o.prototype.addSteps = function(t) {
            ...
            var i, r, s, a, p, h;
            return i = t(o), i.length ? (r = t(e), a = i.offset().top, h = r.height(), p = Math.max(0, a - h / 2), this._debug("Scroll into view. ScrollTop: " + p + ". Element offset: " + a + ". Window height: " + h + "."), s = 0, t("body, html").stop(!0, !0).animate({
