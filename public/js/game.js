...
window.onload = function() {
    ...
    //Main Queue For Game:
     ...
     queue.loadManifest([
        ...
        {id: 'zDe', src: 'skills/zDe.png'},
        {id: 'zDo', src: 'skills/zDo.png'},
        {id: 'zTs', src: 'skills/zTs.png'},
        {id: 'zBa', src: 'skills/zBa.png'},
        ...
        {id: '10000', src: 'skills/10000.png'},
        {id: '10001', src: 'skills/10001.png'},
        {id: '10002', src: 'skills/10002.png'},
        {id: '10003', src: 'skills/10003.png'},
        {id: '10004', src: 'skills/10004.png'},
        {id: '10005', src: 'skills/10005.png'},
        {id: '10006', src: 'skills/10006.png'},
        {id: '10007', src: 'skills/10007.png'},
        {id: '10008', src: 'skills/10008.png'},
        {id: '10009', src: 'skills/10009.png'},
        {id: '10010', src: 'skills/10010.png'},
        {id: '10011', src: 'skills/10011.png'},
        {id: '10012', src: 'skills/10012.png'},
        {id: '10013', src: 'skills/10013.png'},
        {id: '10014', src: 'skills/10014.png'},
        {id: '10015', src: 'skills/10015.png'},
        {id: '10016', src: 'skills/10016.png'},
        {id: '10017', src: 'skills/10017.png'},
        {id: '10018', src: 'skills/10018.png'},
        {id: "10020", src: "skills/10020.png"},
...
function skillList(a, c) {
    ...
    switch (a) {
        ...
        case 92:
            ...
            b.push(1); //Bp Cost
            b.push(1); //Cooldown
            b.push("This skill has a clash effect. Burter punches an enemy at high speed dealing 15 strength damage to one enemy and if Burters speed is higher than his opponent, this skill deals piercing. If Blue Hurricane Crasher is in effect this skill will stun friendly skills for 1 turn. This skill will do an additional 10 damage to an enemy affected by G-force. If this skill is used in combination with Crusher Ball the target will recieve 1 G-Force Mark.");
            b.push(30); //Energy
...
function characterList(a, c) {
 ...
 //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                 ...
                 case "zGu":
                     if (c[1] === "10001") {
                         b.push("Goku Z enters Kaioken, gaining an upsurge in technique by pushing his power beyond its limits.");
                         ...
                         b.push("Goku is one of the strongest Saiyans alive and is the main character of the series. His current attribute is Spiker. He gains technique but loses defense when fully powered. Goku Z is great for players who like to put a quick end to enemy characters.");
                         b.push("/skills/zGu.png");
                         b.push("Goku (Z)");
                         b.push("Hero,Saiyan");
                         b.push("C");
                     ...
                     // Dende
                 case "zDe":
                     b.push("Dende is the 108th son of Grand Elder Guru and is a Namekian with a unique gift that allows him to heal others. His current attribute is Support. He is able to assist his team with spontaneous recoveries making him great for players who are keen on keeping their team alive. ");
                 ...
                 case "zPo":
                     if (c[1] === "10000") {
                         b.push("Piccolo is a wise strategist who was originally a ruthless enemy of Goku. His current attribute is Tank. Piccolo is able to defend himself and his allies while having solid damage output, making him great for players who are slow at starting their strategies."); //Description
                 ...
                 case "zKG":
                     if (c[1] === "10003") {
                         b.push("Kid Gohan's potential has been unlocked. His power increases by a margin and his focus has been improved.");
                         ...
                         b.push("Kid Gohan transforms into a giant ape and goes on a rampage. His power increases and his only focus is destroying everything in his path.");
                         b.push("/skills/zKG.png");
                         ...
                         b.push("Kid Gohan is the son of Goku and a protege Saiyan. His current attribute is All-Round. He is able to self-support himself while also providing solid damage, making him a character that can be easily mastered.");
                         b.push("/skills/zKG.png");
                         b.push("Kid Gohan (Z)");
                         b.push("Hero,Saiyan,Human");
                         b.push("C");
...
function itemList(a) {
    ...
    switch (a) {
        ...
        case "o7":
            b.push("Baba's Pot");
            b.push("The an ally will have two random effects applied to them.");
            b.push(3);
            b.push(1);
            b.push("Power-Up");
            b.push("Support");
...
function websocketGo() {
    ...
    ws.onmessage = function(m) {
        ...
        switch (server.msg) {
            ...
            case "inventory":
                ...
                teambuilderinfo[2].text = user.kili;
                teambuilderinfo[3].text = Number(teambuilderinfo[3].text) - 1;
                setTimeout(function() {
                    stage.removeChild(teambuilderinfo[4]);
                }, 500);
                stage.addChild(teambuilderinfo[4]);
                break;
            ...
            case "joinPlanet":
                $("#invite").modal("show");
                $("#planetInfo").empty().append('<div class="panel-body shadow4"> Select the society you would like to join and than select the join society! </div> <div class="panel-body"><button class="button2 btn-block">Advance Search </button></div> <br><div class="scrollList" id="societyJoin"> </div><button class="button2 btn-block " id="join" onclick="joinSociety();">Join Society </button>');
            ...
            case "planetControls":
                switch (server.type) {
                    ...
                    case 2:
                        console.log("REPORT");
                        $('#planetInfo1').text(server.report);
                        break;
                    ...
                    case 3:
                        ...
                        $("#inviteList").append('<div class="img-check "><div class="panel-body OB center shadow" id="planetInfo1">' + server.members + ' </div><div class="col-sm-12 " id="planetPanelShow"></div></div>');
                        $("#inviteList").append('<a onclick="selected(this);"  id="" id2="'+a.username+'"  ><div class="panel-body aero shadow white "><div class="col-sm-1 aero "><img src="' + a.avater + ' " class="img-avater img-circle" > </div> <div class="col-sm-4 aero">Name:' + a.username + ' <br> </div><div class="col-lg-3 aero">Average:' + a.average + '%</div><div class="col-sm-4 aero">Streak:' + a.streak + '  </div><div class="col-sm-4 aero ">Power-Level:' + a.power_level + '  </div><div class="col-lg-3 aero">W-L:' + a.wins + "/" + a.losses + '</div><div class="col-sm-3 aero ">Rank:' + a.rank + '  </div></div></a>');
                        $("#inviteList").append('<button class="btn-block button2" onclick="planetControls(2);">Send Invite</button>');
                    ...
                    case 4:
                        ...
                        $("#inviteList").append('<div class="panel-body aero shadow" id="planetInfo1">' + server.members + ' </div>');
                        
                       
                        $("#inviteList").append('<div class="scrollList4 " id="membersList"> </div>');
                        if (a !== "") {
                            a = JSON.parse(a);
                            var length = a.length;
                            for (var x = 0; length > x; x++) {
                                $("#membersList").append('<a href="#"  id="" id2="'+ a[x].username +'"  onclick="selected(this);" ><div class="panel-body aero shadow white"><div class="col-sm-1 aero "><img src="' + a[x].avater + ' " class="img-avater img-circle" > </div> <div class="col-sm-4 aero">Name:' + a[x].username + ' <br> </div><div class="col-lg-3 aero">Average:' + a[x].average + '%</div><div class="col-sm-4 aero">Streak:' + a[x].streak + '  </div><div class="col-sm-4 aero ">Power-Level:' + a[x].power_level + '  </div><div class="col-lg-3 aero">W-L:' + a[x].wins + "/" + a[x].losses + '</div><div class="col-sm-3 aero ">Rank:' + a[x].rank + '  </div></div></a>');
                            }
                            $("#inviteList").append('<button class="btn-block button2" onclick="planetControls(2);">Send Invite</button>');
                        }
                        ...
                        $("#planetInfoError").append('<button class="btn-block button2 " onclick="planetControls(2);">Send Invite</button>');
                    ...
                    case 12:
                        ...
                        if (length > 0) {
                            var display = [];
                            for (var x = 0; length > x; x++) {
                                $("#planetInfo").append('<a href="/user/' + a[x].username + '" target="_blank"  ><div class="panel-body aero shadow"><div class="col-sm-1 aero "><img src="' + a[x].avater + ' " class="img-avater img-circle" > </div> <div class="col-sm-4 aero">Name:' + a[x].username + ' <br> </div><div class="col-lg-3 aero">Average:' + a[x].average + '%</div><div class="col-sm-4 aero">Streak:' + a[x].streak + '  </div><div class="col-sm-4 aero ">Power-Level:' + a[x].power_level + '  </div><div class="col-lg-3 aero">W-L:' + a[x].wins + "/" + a[x].losses + '</div><div class="col-sm-3 aero ">Position:' + a[x].position + '  </div></div></a>');
                            }
                        }
                        else {
    ...
    0, 0, 0, 1, 0 // alpha
                            ...
                            invitePlanet.addEventListener('click', function() {
                                planetControls(5);
                            });
...
function showCharacter(num, num2) {
    ...
    if (num2) {
        ...
        $("#currentlevel").show();
        $("#newlevel").hide();
        $("#savebutton").empty().append('<button type="button" class="button2 btn-block" onclick="clearSkills(' + num + ');" >Change Character</button>');
        switch (num) {
            case 1:
                a = p1stats.c1;
                break;
...
function clearSkills(num) {
    ...
    teambuilderinfo[7].image = queue.getResult("10000");
...
function showSkills(name) {
...

    {
        ...
        case "zGu":
            ...
            $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10001" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10001.png" ></a> </div>');
            break;
        ...
        case "zKG":
            ...
            $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10003" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10003.png" ></a> </div>');
            if (p1stats.us.hasOwnProperty("10002") === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10002" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10002.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" ><img class="notunlocked img responsive  "  src="/skills/10002.png" ></a> </div>');
            }
            break;
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/148.png" ></a> </div>'); 
}
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/149.png" ></a> </div>'); 
}
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/150.png" ></a> </div>'); 
}
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/145.png" ></a> </div>'); 
}
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/146.png" ></a> </div>'); 
}
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/147.png" ></a> </div>'); 
}
if (p1stats.us.hasOwnProperty("10020") === true )
{ 
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10020" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10020.png" ></a> </div>');  
}
else
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/10020.png" ></a> </div>'); 
}
 ...
 break;
        ...
        case "zRi":
            ...
            if (p1stats.us.hasOwnProperty(10012) === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10012" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10012.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10012" data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10012.png" ></a> </div>');
            }
        ...
        case "zNy":
            ...
            if (p1stats.us.hasOwnProperty(10014) === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10014" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10014.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10014" data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10014.png" ></a> </div>');
            }
            ...
            case "zDe":
 genericSkills(1);
 if (p1stats.us.hasOwnProperty("127") === true )
{ 
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/127.png" ></a> </div>'); 
}
if (p1stats.us.hasOwnProperty("128") === true )
{ 
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/128.png" ></a> </div>'); 
}
if (p1stats.us.hasOwnProperty("129") === true )
{ 
...
{
$(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  ><img class="notunlocked img responsive  "  src="/skills/129.png" ></a> </div>'); 
}
 ...
 break;
        ...
        case "zGJ":
            ...
            if (p1stats.us.hasOwnProperty(10016) === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10016" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10016.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10016" data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10016.png" ></a> </div>');
            }
            break;
        ...
        case "zCr":
            ...
            if (p1stats.us.hasOwnProperty("10017") === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10017" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10017.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10017" data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10017.png" ></a> </div>');
            }
            break;
        ...
        case "zZn":
            ...
            if (p1stats.us.hasOwnProperty("10010") === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10010" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10010.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10010" data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10010.png" ></a> </div>');
            }
            break;
        ...
        case "bKG":
            ...
            if (p1stats.us.hasOwnProperty("10018") === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10018" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10018.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10018" data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10018.png" ></a> </div>');
            }
            break;
        ...
        case "zNl":
            ...
            if (p1stats.us.hasOwnProperty("10006") === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10006" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10006.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10006.png" ></a> </div>');
            }
            break;
        ...
        case "zKn":
            ...
            $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10005" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10005.png" ></a> </div>');
        ...
        case "zNy":
            ...
            if (p1stats.us.hasOwnProperty(10014) === true) {
                ...
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10014.png" ></a> </div>');
            }
            break;
        ...
        case "zGr":
            ...
            if (p1stats.us.hasOwnProperty(10015) === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10015" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10015.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10015.png" ></a> </div>');
            }
            break;
        ...
        case "zSo":
            ...
            if (p1stats.us.hasOwnProperty(10013) === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10013" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10013.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10013.png" ></a> </div>');
            }
            break;
        ...
        case "zSn":
            ...
            if (p1stats.us.hasOwnProperty(10009) === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10009" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10009.png" ></a> </div>');
            }
            else {
        ...
        case "zGy":
            ...
            if (p1stats.us.hasOwnProperty(10011) === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10011" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10011.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10011.png" ></a> </div>');
            }
            break;
        ...
        case "zNa":
            ...
            if (p1stats.us.hasOwnProperty("10007") === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10007" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10007.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10007.png" ></a> </div>');
            }
            break;
        ...
        case "zSV":
            ...
            if (p1stats.us.hasOwnProperty("10008") === true) {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#" data-move="10008" data-type="T" onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10008.png" ></a> </div>');
            }
            else {
                $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="unqiue"><a href="#"  data-type="T" ><img class="notunlocked img responsive  "  src="/skills/10008.png" ></a> </div>');
            }
            break;
    ...
    function genericSkills(n) {
        ...
        $(".select").append('<div class="item-to-tag col-xs-3 col-sm-2 img" data-item-tags="generic"><a href="#" data-move="10000" data-type="T"  onclick="skillD(this,false);return false;"><img class="img responsive  "  src="/skills/10000.png" ></a> </div>');
    }
...
{    
     ...
     if (Number(num) >= 10000)
     {
         ...
         console.log("WIn: " + p1stats.hold[2]);
        var b = skillList(num2, [1, num, 0, 0]);
         console.log(b);
     }
     else 
     {
           console.log("Los");
          var b = skillList(num, [0]); 
     }
...

{
    ...
    if (t) {
      ...
      if (b[8][0] !== "None")
        ...
        $("#currentstats").text("EP:" + b[4] + " CD:" + b[2] + " BP:" + b[1] + " Focus:" + b[7] + " Type:" + b[6]);
        a = a.toString();
        $("#savebutton").empty().append('<button type="button" class="button2 btn-block" onclick="updateSkills();" >Change Skill</button>');
    }
...
tutorial(0);
    ...
    dragonverse.graphics.beginFill("#000").rect(175, 235, 850, 180);
    dragonverse.alpha = 0.01;
    dragonverse.cursor = "pointer";
    stage.addChild(dragonverse);
    dragonverse.addEventListener("click", function() {
        loading(7);
    });

    var inventory = new createjs.Shape();
    inventory.graphics.beginFill("#000").rect(625, 458, 180, 180);
    ...
    teambuilder.graphics.beginFill("#000").rect(400, 458, 180, 180);
    teambuilder.alpha = 0.01;
    teambuilder.cursor = "pointer";
    stage.addChild(teambuilder);
    teambuilder.addEventListener("click", function() {
        loading(2);
    });
    ...
    capsuleCorp.addEventListener("click", function() {
        loading(3);
    });
...
//user.money
    var zennie = new createjs.Text("Welcome,"+ user.username + "\nRatio:" + user.wins + "/" + user.losses + "(" +user.streak+")"+ "\nRank:" + user.rank+ "  Zennie:"+ user.money, "18px OB", "white");
    zennie.x = 500;
    zennie.y = 68;
    zennie.lineHeight = 20;
    zennie.shadow = new createjs.Shadow("rgba(0,0,0,0.5)", 2, 2, 2);
...
function loading(num) {
    ...
    loadingSettings[1].x = 454;
    loadingSettings[1].y = 630;
    stage.addChild(loadingSettings[1]);


    var shape = new createjs.Shape();
    loadingSettings[2] = shape.graphics.beginFill("orange").drawRect(457, 633, 1, 34).command;
    stage.addChild(shape);

    loadingSettings[3] = new createjs.Text("Loading Game", "30px OB", "white");
    loadingSettings[3].x = 550;
    loadingSettings[3].y = 610;
    ...
    switch (num) {
        ...
        case 3:
            queue.loadManifest([
                ...
                {
                    id: 'shopbanner1',
                    src: 'assets/shopbanner1.png'
                },
                {
                    id: 'shopbanner2',
                    src: 'assets/shopbanner2.png'
                },
                {
                    id: 'resultsound',
                    src: 'assets/strongpunch.mp3'
                },
                {
                    id: 'reward',
        ...
        case 4:
            queue.loadManifest([
                ...
                {
                    id: 'tagscrafting',
                    src: 'assets/tagscrafting.png'
                },
                {
                    id: 'tagsconvert',
                    src: 'assets/tagsconvert.png'
                },
                {
                    id: 'craft',
                ...
                {
                    id: 'inventorypopup',
                    src: 'assets/inventorypopup.png'
                },
                 {
                    id: 'inventoryAnimations',
                    src: 'assets/inventoryAnimations.png'
                },
        ])
            break;
        ...
        case 5:
            ...
            queue.loadManifest([
                {
                    id: 'searchBackground',
                    src: 'assets/actionbar.png'
                }, // Searching BG
                {
                    id: 'contentsBackground',
                    src: 'assets/leftholder-grey.png'
                }, // Main Content
                {
                    id: 'avatarHold',
                    src: 'assets/avatarhold.png'
                },
                {
                    id: 'actionsBackground',
                    src: 'assets/rightholder-grey.png'
                }, // Current Effects
                {
                    id: 'skillsBackground',
                    src: 'assets/skillholder.png'
                }, // SKill
                {
                    id: 'mainBackground',
                ...
                {
                    id: 'battlescreen',
                    src: 'assets/battlescreen.png'
                }, // 
                {
                    id: 'itemboxBackground',
                    src: 'assets/itembox.png'
                }, // Items Box
                {
                    id: 'statusBackground',
                    src: 'assets/phasebutton.png'
                }, // BP/Timer Box
                {
                    id: 'endturnHold',
                    src: 'assets/actionbar.png'
                }, // End turn / Surrender Box
                {
                    id: 'blinkingeffect',
                    src: 'assets/blinkingimage-red.png'
                }, // 
                {
                    id: 'cooldownbox',
                    src: 'assets/cooldownbox-white.png'
                }, // 
                {
                    id: 'player2hold',
                ...
                {
                    id: 'healthbarhold',
                    src: 'assets/hpbar.png'
                }, // Player 2
                {
                    id: 'energybarhold',
                    src: 'assets/epbar.png'
                }, // Player 2
                {
                    id: 'search',
                ...
                {
                    id: 'turnEnd',
                    src: 'assets/turnEnd.mp3'
                },
                {
                    id: 'death',
                    src: 'assets/death1.mp3'
                },
                {
                    id: 'aura',
                    src: 'assets/aura.mp3'
                ...
                {
                    id: 'aura2',
                    src: 'assets/aura3.png'
                },
                {
                    id: 'aura3',
                    src: 'assets/aura4.png'
                },
                {
                    id: 'aura4',
                    src: 'assets/aura5.png'
                },
                {
                    id: 'done',
                ...
                {
                    id: 'surrenderpic',
                    src: 'assets/gohan.png'
                },
                {
                    id: 'endturnpic',
                    src: 'assets/endturnpic.png'
                },
                {
                    id: 'find',
                    src: 'assets/sprite2.png'
                },
                {
                    id: 'found',
                    src: 'assets/sprite1.png'
                },
                {
                    id: 'cancelLoad',
                ...
                {
                    id: 'endturn',
                    src: 'assets/endturn.png'
                },
                {
                    id: 'forfeit',
                    src: 'assets/forfeit.png'
                },
                {
                    id: 'Win',
                    src: 'assets/Win.png'
                ...
                {
                    id: 'powerDownanimation',
                    src: 'assets/power-down.png'
                },
                {
                    id: 'powerUpanimation',
                    src: 'assets/power-up.png'
                },
                {
                    id: 'defenseanimation',
                ...
                {
                    id: 'Afflictionanimation',
                    src: 'assets/Affliction.png'
                },
                {
                    id: 'stunnedanimation',
                    src: 'assets/stunned.png'
                },
                {
                    id: 'strengthsound',
                    src: 'assets/strength.mp3'
                },
                {
                    id: 'kisound',
                    src: 'assets/ki.mp3'
                ...
                {
                    id: 'powerdownsound',
                    src: 'assets/powerdown.mp3'
                },
                {
                    id: 'Afflictionsound',
                    src: 'assets/Affliction.mp3'
                },
                {
                    id: 'powerupsound',
                ...
                {
                    id: 'defensesound',
                    src: 'assets/defense.mp3'
                },
                {
                    id: 'stunnedsound',
                    src: 'assets/stunned.mp3'
                },
            ])
        ...
        case 7:
            queue.loadManifest([{
                ...
                {
                    id: 'planet1text',
                    src: 'assets/planet1text.png'
                },
                {
                    id: 'planet2text',
                    src: 'assets/planet2text.png'
                },
                {
                    id: 'planet3text',
                    src: 'assets/planet3text.png'
                },
                {
                    id: 'planetType1',
                    src: 'assets/planetType1.png'
                },
                {
                    id: 'planetType2',
                    src: 'assets/planetType2.png'
                },
                {
                    id: 'planetType3',
                    src: 'assets/planetType3.png'
                },
                {
                    id: 'planetType4',
                    src: 'assets/planetType4.png'
                },
                {
                    id: 'planetType5',
                    src: 'assets/planetType5.png'
                },
                {
                    id: 'planetType6',
                    src: 'assets/planetType6.png'
                },
                {
                    id: 'planetMenu',
                    src: 'assets/planetMenu.png'
                },
                {
                    id: 'bc1',
                    src: 'assets/bc1.png'
                ...
                {
                    id: 'pcexit',
                    src: 'assets/pcexit.png'
                },
                {
                    id: 'pcconfirm',
                    src: 'assets/pcconfirm.png'
                },
                {
                    id: 'planetconfirm',
                    src: 'assets/planetconfirm.png'
                },
                {
                    id: 'dragonversepanel',
                    src: 'assets/dragonversepanel.png'
                },
                {
                    id: 'dailyQuestMenu',
                    src: 'assets/dailyQuestMenu.png'
                },
                {
                    id: 'x',
                    src: 'assets/X.png'
                ...
                {
                    id: 'mainPhase',
                    src: 'assets/mainPhase.png'
                },
                {
                    id: 'AssetsButton',
                    src: 'assets/AssetsButton.png'
                },
                {
                    id: 'BioButton',
                    src: 'assets/BioButton.png'
                },
                {
                    id: 'commanderButton',
                    src: 'assets/commanderButton.png'
                },
                {
                    id: 'quitButton',
                    src: 'assets/quitButton.png'
                },
                {
                    id: 'managementButton',
                    src: 'assets/managementButton.png'
                },
                {
                    id: 'defendButton',
                    src: 'assets/defendButton.png'
                },
...
/*
        ...
        */
        ...
        planetType3.x = 750;
        planetType3.y = 360;
        planetType3.addEventListener('click', function() {
            confirmPlanet(3);
        });
...
/*
        ...
        */
        ...
        planetType6.addEventListener('click', function() {
            confirmPlanet(6);
        });
        ...
        pcexit.y = 250;
        pcexit.alpha = 0;
        pcexit.addEventListener('click', function() {
            planetButton(2);
        });
        ...
        planet1.addEventListener('click',searchPlanet);

        createjs.Tween.get(planet1, {
                loop: true
            })
            .to({
                y: 203
            }, 1000, createjs.Ease.linear) //10
            .to({
                y: 197
            }, 1000, createjs.Ease.linear) //10
            .to({
        ...
        planetrequest.addEventListener('click', function() {
            planetControls(5);
        });
        ...
        planetpanel.addEventListener('click', function() {
            planetPanelShow(teambuilderinfo)
        });
        ...
        leftarrow.graphics.beginFill("#000").rect(170, 315, 50, 50);
        ...
        rightarrow.graphics.beginFill("#000").rect(975, 315, 50, 50);
...
var currentPlanetcount = 3;
        ...
        function arrow(num)
        {
            if (num === 1)
            {
                switch(currentPlanetcount)
                {
                    case 1:
                    currentPlanetcount = 3;
                    planet1.image = queue.getResult("planet3");
                    currentPlanet.image = queue.getResult("planet3text");
                    break;
                    
                    case 2:
                    currentPlanetcount = 1;
                    planet1.image = queue.getResult("planet5");
                    currentPlanet.image = queue.getResult("planet1text");
                    break;
                    
                    case 3:
                    currentPlanetcount = 2;
                    planet1.image = queue.getResult("planet6");
                    currentPlanet.image = queue.getResult("planet2text");
                    break;
                }
            }
            else
    ...
    function confirmPlanet(num) {
        ...
        switch (num) {
            ...
            case 5:
                ...
                confirmText.text = 'Hitman this group is for sole fighters looking for sole play.Hitman are neutual group that only cares about getting paid.';
                choose1 = "planetType2";
                choose2 = "planet5";
            ...
            case 3:
                ...
                confirmText.text = 'Human race job is to raise funding for allies and advancing.';
                choose1 = "planetType3";
                choose2 = "planet3";
        ...
        createjs.Tween.get(planetconfirm, {
                loop: false
            })
            .to({
                alpha: 1
        ...
        createjs.Tween.get(confirmAvater, {
                loop: false
            })
            .wait(1000)
            .to({
        ...
        pcconfirm.alpha = 0;
        pcexit.alpha = 0;
        createjs.Tween.get(confirmText, {
                loop: false
            })
            .wait(1000)
            .to({
    ...
    function planetButton(num) {
        ...
        if (num === 1) {
            ...
            createjs.Tween.get(planetType1, {
                    loop: false
                })
                .wait(1000)
                .to({
            ...
            createjs.Tween.get(planetType2, {
                    loop: false
                })
                .wait(1000)
                .to({
            ...
            createjs.Tween.get(planetType3, {
                    loop: false
                })
                .wait(1000)
                .to({
            ...
            createjs.Tween.get(planetType4, {
                    loop: false
                })
                .wait(1000)
                .to({
            ...
            createjs.Tween.get(planetType5, {
                    loop: false
                })
                .wait(1000)
                .to({
            ...
            createjs.Tween.get(planetType6, {
                    loop: false
                })
                .wait(1000)
                .to({
            ...
            bc1.y = 300;
            bc1.alpha = 0;
            bc1.addEventListener('click', function() {
                planet2Button(1);
            });
            bc1.cursor = "pointer";
            stage.addChild(bc1);
            ...
            bc3.y = 300;
            bc3.alpha = 0;
            bc3.addEventListener('click', function() {
                planet2Button(3);
            });
            bc3.cursor = "pointer";
            stage.addChild(bc3);
...
function planetControls(num) {
    ...
    switch (num) {
        ...
        case 5:
            ...
            if (length > 0) {
                for (var x = 0; length > x; x++) {
                    $("#inviteList").append('  <div class="panel-body TW shadow " > <div class="col-lg-2"> <img class="img-avater img-circle" src="' + a[x].avater + '"> </div><a href="#" onclick="selected(this)" id="" id2="' + a[x].main_planet + '" id3="' + a[x].name + '"><div class="col-lg-4">Name:' + a[x].name + '</div></a><div class="col-lg-4">Rep:' + a[x].reputation + '</div><button class="button2 col-lg-2 btn-sm" onclick="selected(this);planetControls(6);" id2="' + a[x].id + '">Join</button><div class="col-lg-4">Members:' + a[x].members_count + '/' + a[x].members_limit + ' </div><div class="col-lg-4">Invite:' + a[x].invite + '</div><button class="button2 col-lg-2 btn-sm" id2="' + a[x].id + '" onclick="selected(this);planetControls(7);">Reject</button></div>')
                }
...
function planetPanelShow(info) {
    ...
    if (b.main_planet === "Human")
    {
        c = "planet3";
    }
    else if (b.main_planet === "Cold")
    {
        c = "planet6";
    }
    else if (b.main_planet === "Hitman")
    {
        c = "planet5";
    }

    var planet1 = new createjs.Bitmap(queue.getResult(c));
    planet1.x = 270;
    planet1.y = 230;
    //planet1.cursor = "pointer";
    stage.addChild(planet1);
    ...
    if (!member) {
        ...
        defendButton.addEventListener("click", quickmatch);
...
function Team() {
    ...
    button1.cursor = "pointer";
    stage.addChild(button1);
    button1.addEventListener("click", function(){quickLink(1)});
    ...
    teambuilderinfo[0].addEventListener('click', function() {
         showCharacter(1, true);
    });
    teambuilderinfo[0].addEventListener('mouseover', function() {
        hovercharacter(1);
    });
    ...
    teambuilderinfo[1].addEventListener('click', function() {
        showCharacter(2, true);
    });
    teambuilderinfo[1].addEventListener('mouseover', function() {
        hovercharacter(2);
    });
    ...
    teambuilderinfo[2].addEventListener('click', function() {
        showCharacter(3, true);
    });
    teambuilderinfo[2].addEventListener('mouseover', function() {
        hovercharacter(3);
    });
    ...
    teambuilderinfo[3].addEventListener('click', function() {
        skillD(0, true);
    });
    ...
    stage.addChild(teambuilderinfo[4]);
    teambuilderinfo[4].addEventListener('click', function() {
        skillD(1, true);
    });
    ...
    stage.addChild(teambuilderinfo[5]);
    teambuilderinfo[5].addEventListener('click', function() {
        skillD(2, true);
    });
    ...
    stage.addChild(teambuilderinfo[6]);
    teambuilderinfo[6].addEventListener('click', function() {
        skillD(3, true);
    });
    ...
    stage.addChild(teambuilderinfo[7]);
    teambuilderinfo[7].addEventListener('click', function() {
        skillD(4, true);
    });
    ...
    var chartshow = new createjs.Bitmap(document.getElementById("info"));
chartshow.x = 110;
chartshow.y = 330;
stage.addChild(chartshow);
...
function inventoryOpen() {
    ...
    charactertags.graphics.beginFill("#000").rect(97, 170, 260, 40);
    charactertags.alpha = 0.01;
    charactertags.cursor = "pointer";
    stage.addChild(charactertags);
    charactertags.addEventListener('click', function() {
        inventoryTags(1);
    });

    var skillstags = new createjs.Shape();
    skillstags.graphics.beginFill("#000").rect(400, 170, 260, 40);
    skillstags.alpha = 0.01;
    skillstags.cursor = "pointer";
    stage.addChild(skillstags);
    skillstags.addEventListener('click', function() {
        inventoryTags(2);
    });
...
/*
    ...
    itemstags.addEventListener('click', function() {
        inventoryTags(3);
    });
    ...
    extratags.addEventListener('click', function() {
        inventoryTags(4);
    });
    ...
    */
    ...
    crafting.addEventListener("click", function() {
        changeInventory(1);
    });
    ...
    teambuilderinfo[2] = new createjs.Text(user.kili, "18px OB", "white");
    teambuilderinfo[2].x = 855;
    teambuilderinfo[2].y = 247;
    teambuilderinfo[2].shadow = new createjs.Shadow("rgba(0,0,0,0.5)", 2, 4, 3);
    teambuilderinfo[2].textBaseline = "alphabetic";
    stage.addChild(teambuilderinfo[2]);
    ...
    var data = {
        images: [queue.getResult('inventoryAnimations')],
        frames: {
            width: 75,
            height: 75
        },
    ...
    teambuilderinfo[4] = new createjs.Sprite(spriteSheet, "run");
    teambuilderinfo[4].x = 450;
    teambuilderinfo[4].y = 230;
    teambuilderinfo[4].scaleX = 1.5;
    teambuilderinfo[4].scaleY = 1.5;
    ...
    teambuilderinfo[3] = new createjs.Text("", "14px OB", "white");
    teambuilderinfo[3].x = 790;
    teambuilderinfo[3].y = 178;
    teambuilderinfo[3].textBaseline = "alphabetic";
    teambuilderinfo[3].textAlign = "center";
...
//moo
  var check = Number(teambuilderinfo[3].text);
                if (previewImage.id === 1 && uc[previewImage.name] != 0 && check != 0) {
                    console.log("There are this many of the character: " + uc[previewImage.name]);
                    var file = {
                        action: "inventory",
                        choice: previewImage.name,
                        tag: tagnumber,
                        type: previewImage.id
                    };
                    ws.send(JSON.stringify(file));
                }
                else if (previewImage.id === 2 && us[previewImage.name] != 0 && check != 0) {
                    var file = {
                        action: "inventory",
                        choice: previewImage.name,
                        tag: tagnumber,
...
console.log("Inventory Add");
            if (previewImage.id === 1) {
                ...
                if (skill[10] === "L") {
                    ...
                    inventoryTextPop.text = 1250;
                }

                else {
                    inventoryTextPop.text = 125;
                }
            }
...
console.log("Inventory Remove");
            if (previewImage.id === 1) {
                ...
                console.log("Rarity : " + character[4] + "  Image: " + previewImage.name);
                if (character[4] === "L") {
                    inventoryTextPop.text = 40000;
                }
                
                else if (character[4] === "S") {
                    inventoryTextPop.text = 20000;
                }
                ...
                console.log("Rarity : " + skill[8] + "  Image: " + previewImage.name);
                if (skill[10] === "L") {
                    inventoryTextPop.text = 32000;
                }
                
                else if (skill[10] === "S") {
                    inventoryTextPop.text = 16000;
                }
...
stage.removeChild(amount);
        ...
        if (num2 === 1) {
            ...
            uc = JSON.parse(user.uc);
            teambuilderinfo[3].text = uc[num];
            stage.addChild(teambuilderinfo[3]);
...
//moo3
                if (inventoryOn === 1) {
                    ...
                    arrayKeys = Object.keys(uc)
                    arrayKeys2 = allInfo(1);
                    arrayKeys = arrayKeys2.filter(function(val) {
                        return arrayKeys.indexOf(val) == -1;
                    });
    ...
    function inventoryTags(num, num2) {
        ...
        if (tagnumber === 1) {
            ...
            if (num === 1) {
                ...
                inventoryOn = 2;
                length = (Object.keys(us).length - 1) / 24;
                arrayKeys = Object.keys(us)
                arrayKeys2 = allInfo(4);
                arrayValues = Object.values(us);
                inventorySlot = 1;
            ...
            if (num === 1) {
                ...
                console.log("inventoryLastNumber: " + inventoryLastNumber);
                inventoryText.text = inventorySlot + "/" + inventoryLastNumber;
...
function allInfo(num) {
    ...
    var a;
    if (num === 1) {
        a = ["zGo", "zGy", "zSn", "zRz", "zNl", "zNa", "zSV", "zCi", "zRe", "zJe", "zBr", "zRi", "bKG","zGJ","zDo","zDe","zTs","zSo","zNy","zGr","zDa","zZn","zCr","zMa","zBa"];
    }

    else if (num === 2) {
        a = ["49", "50", "51", "56", "57", "58", "59", "70", "71", "72", "73", "74", "75", "79", "80", "81", "82", "83", "84", "85", "86", "87", "88", "89", "90", "91", "92", "93", "94", "95", "96", "97", "98", "99", "100", "101", "102", "106", "107", "108", "109", "110", "111", "10000", "10001", "10002", "10004", "10005", "10006", "10007","10011", "10008", "10012", "10018", "10009"];
    }
        ...
        a = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "31", "32", "34", "36", "37", "38", "42", "43", "45", "46", "47", "48", "52", "53", "54", "58", "59", "60", "61", "62", "63", "64", "65", "66", "67", "68", "69", "10000", "10001", "10002", "10003", "10004", "10005", "10006", "10007", "10008", "10009", "10010", "10011", "10012"];
    }
...
tutorial(8);
    ...
    itemHold.graphics.beginFill("#000").rect(222, 88, 85, 85);
    itemHold.alpha = 0.01;
    ...
    shop_roll1.graphics.beginFill("#000").rect(20, 610, 260, 58);
    shop_roll1.alpha = 0.01;
    shop_roll1.cursor = "pointer";
    shop_roll1.addEventListener("click", function() {
        shopconfirm(1);
    });
    stage.addChild(shop_roll1);

    var shop_roll2 = new createjs.Shape();
    shop_roll2.graphics.beginFill("#000").rect(300, 610, 260, 58);
    shop_roll2.alpha = 0.01;
    shop_roll2.cursor = "pointer";
    shop_roll2.addEventListener("click", function() {
        shopconfirm(2);
    });
    stage.addChild(shop_roll2);

    var shop_roll3 = new createjs.Shape();
    shop_roll3.graphics.beginFill("#000").rect(640, 610, 240, 58);
    shop_roll3.alpha = 0.01;
    shop_roll3.cursor = "pointer";
    shop_roll3.addEventListener("click", function() {
        shopconfirm(3);
    });
    stage.addChild(shop_roll3);

    var shop_roll4 = new createjs.Shape();
    shop_roll4.graphics.beginFill("#000").rect(910, 610, 240, 58);
    shop_roll4.alpha = 0.01;
    shop_roll4.cursor = "pointer";
    shop_roll4.addEventListener("click", function() {
        shopconfirm(4);
    });
    ...
    function shopconfirm(a) {
        ...
        if (user.money >= 3000 && a === 1) {
            ...
            setTimeout(function() {
                ...
                createjs.Tween.get(backgroundcover, {
                        loop: false
                    })
                    .to({
                        alpha: 0.01
...
function gameLoop() //num
{
    ...
    var p1character1 = {
        ...
        moveUsed: 0,
        attacked: false,
        cooldown: start.y_c1_cooldown,
        skills: skill1,
        active: false,
        targeted: -1,
        order: -1,
        stunned: start.y_c1_stunned,
        box: -1,
        block: start.y_c1_block,
        effects: p1effects1,
        current: 1,
        player: true,
        conditions: start.y_c1_conditions
    };
    var p1character2 = {
        c: c[1],
        moveUsed: 0,
        attacked: false,
        cooldown: start.y_c2_cooldown,
        skills: skill2,
        active: false,
        targeted: -1,
        order: -1,
        stunned: start.y_c2_stunned,
        box: -1,
        block: start.y_c2_block,
        effects: p1effects2,
        current: 2,
        player: true,
        conditions: start.y_c2_conditions
    };
    var p1character3 = {
        c: c[2],
        moveUsed: 0,
        attacked: false,
        cooldown: start.y_c3_cooldown,
        skills: skill3,
        active: false,
        targeted: -1,
        order: -1,
        stunned: start.y_c3_stunned,
        box: -1,
        block: start.y_c3_block,
        effects: p1effects3,
        current: 3,
        player: true,
        conditions: start.y_c3_conditions
    };
    var p2character1 = {
        stunned: start.o_c1_stunned,
        box: -1,
        block: start.o_c1_block,
        effects: p2effects1,
        conditions: start.o_c1_conditions,
        current: 1,
        player: false
    };
    var p2character2 = {
        stunned: start.o_c2_stunned,
        box: -1,
        block: start.o_c2_block,
        effects: p2effects2,
        conditions: start.o_c2_conditions,
        current: 2,
        player: false
    };
    var p2character3 = {
        stunned: start.o_c3_stunned,
        box: -1,
        block: start.o_c3_block,
        effects: p2effects3,
        conditions: start.o_c3_conditions,
        current: 3,
        player: false
    };
    var doneNow;
    ...
    backgroundImage1.x = 0;
    backgroundImage1.y = 0;
    createjs.Tween.get(backgroundImage1, {
            loop: true
        })
        .to({
            x: -400,
            scaleX: 0.8,
            scaleY: 0.8
        }, 5000, createjs.Ease.linear) //5
        .to({
            x: 0,
            y: -20
        }, 5000, createjs.Ease.linear) //10
        .to({
            x: -500,
            y: -50,
            scaleX: 1.2,
            scaleY: 1.2
        }, 5000, createjs.Ease.linear) //15
        .to({
            x: -200,
            y: -120
        }, 6000, createjs.Ease.linear) //20
        .to({
            x: -300
        }, 5000, createjs.Ease.linear) //25
        .to({
            x: -450,
            scaleX: 1.1,
            scaleY: 1.1
        }, 2000, createjs.Ease.linear) //27
        .to({
            x: -250
        }, 2000, createjs.Ease.linear) //30
        .to({
            x: -30,
            y: -10
        }, 2000, createjs.Ease.linear) //35
        .to({
            x: -500,
            y: -90
        }, 3000, createjs.Ease.linear) //35
        .to({
            x: -10,
            scaleX: 1.0,
            scaleY: 1.0
        }, 4000, createjs.Ease.linear) //40
        .to({
            x: -400
        }, 3000, createjs.Ease.linear) //40
        .to({
            x: 0,
            y: -70
        }, 5000, createjs.Ease.linear)
    ...
    createjs.Tween.get(fighting, {
        ...
        .to({
            ...
            scaleX: 2.8,
            scaleY: 2.8
        }, 1500, createjs.Ease.linear) //5
        .to({
            x: 670,
            y: 20
        }, 1, createjs.Ease.linear) //10
        .wait(2000)
        .to({
            x: 110,
            y: 230,
    ...
    player1avater.addEventListener("click", function() {
        avatershow(1);
    });
    ...
    player2avater.addEventListener("click", function() {
        avatershow(2);
    });
    ...
    // Character levels.
    var p1leveltext1 = new createjs.Text("", "22px OB", "white");
    p1leveltext1.x = 482;
    p1leveltext1.y = 413;
    ...
    var cooldown1text = new createjs.Text("", "60px OB", "black");
    cooldown1text.x = 65;
    cooldown1text.y = 478;

    var cooldown2text = new createjs.Text("", "60px OB", "black");
    cooldown2text.x = 148;
    cooldown2text.y = 478;

    var cooldown3text = new createjs.Text("", "60px OB", "black");
    cooldown3text.x = 236;
    cooldown3text.y = 478;

    var cooldown4text = new createjs.Text("", "60px OB", "black");
    cooldown4text.x = 312;
    cooldown4text.y = 478;

    var cooldown5text = new createjs.Text("", "60px OB", "black");
    cooldown5text.x = 401;
    cooldown5text.y = 478;
    ...
    for (var i = 0, len = p1effects1.length; i < len; i++) {
        ...
        if (p1effects1[i] === p1effects1[i + 1]) {
            ...
            countText[last] = new createjs.Text(count, "18px IMPACT", "white");
    ...
    createjs.Tween.get(player1bar[3], {
            loop: false
        })
        .wait(1000)
        .to({
            w: start.y_c1_energy / start.y_c1_max[1] * 181
        }, 2000);
    ...
    createjs.Tween.get(player1bar[4], {
            loop: false
        })
        .wait(1000)
        .to({
            w: start.y_c2_energy / start.y_c2_max[1] * 181
        }, 2000);
    ...
    createjs.Tween.get(player1bar[5], {
            loop: false
        })
        .wait(1000)
        .to({
            w: start.y_c3_energy / start.y_c3_max[1] * 181
        }, 2000);
    ...
    createjs.Tween.get(player2bar[3], {
            loop: false
        })
        .wait(1000)
        .to({
            w: start.o_c1_energy / start.o_c1_max[1] * 181
        }, 2000);
    ...
    createjs.Tween.get(player2bar[4], {
            loop: false
        })
        .wait(1000)
        .to({
            w: start.o_c2_energy / start.o_c2_max[1] * 181
        }, 2000);
    ...
    createjs.Tween.get(player2bar[5], {
            loop: false
        })
        .wait(1000)
        .to({
            w: start.o_c3_energy / start.o_c3_max[1] * 181
        }, 2000);
    ...
    createjs.Tween.get(P1BlinkingBox1, {
            loop: true
        })
        .to({
            alpha: .4
    ...
    createjs.Tween.get(P1BlinkingBox2, {
            loop: true
        })
        .to({
            alpha: .4
    ...
    createjs.Tween.get(P1BlinkingBox3, {
            loop: true
        })
        .to({
            alpha: .4
    ...
    createjs.Tween.get(P2BlinkingBox1, {
            loop: true
        })
        .to({
            alpha: .4
    ...
    createjs.Tween.get(P2BlinkingBox2, {
            loop: true
        })
        .to({
            alpha: .4
    ...
    createjs.Tween.get(P2BlinkingBox3, {
            loop: true
        })
        .to({
            alpha: .4
    ...
    createjs.Tween.get(P1triangle1, {
            loop: true
        })
        .to({
            y: triangley
        ...
        .to({
            ...
            scaleX: 0.7,
            scaleY: 0.7
        }, 200, createjs.Ease.getPowInOut(1))
        .to({
            y: triangley + 20,
            x: trianglex + 20
        }, 200, createjs.Ease.getPowInOut(2))
    ...
    createjs.Tween.get(P1triangle2, {
            loop: true
        })
        .to({
            y: triangley + 15
    ...
    createjs.Tween.get(P1triangle3, {
            loop: true
        })
        .to({
            y: triangley + 15
    ...
    createjs.Tween.get(P2triangle1, {
            loop: true
        })
        .to({
            y: triangley + 15
    ...
    createjs.Tween.get(P2triangle2, {
            loop: true
        })
        .to({
            y: triangley + 15
    ...
    createjs.Tween.get(P2triangle3, {
            loop: true
        })
        .to({
            y: triangley + 15
    ...
    function turnAnimation() {
        ...
        if (battlelogs[z] === 0) {
            ...
            showActions.alpha = 1;
            createjs.Tween.get(showActions, {
                    loop: false
                })
                .to({
                    scaleX: 3,
                    ...
                    y: 200,
                    x: 300
                }, 800, createjs.Ease.linear) //5
                .to({
                    alpha: 0
                }, 200, createjs.Ease.linear) //5
                .call(function() {
                    effectAnimation(0, true)
                })
            ...
            .call(function() {
                    effectAnimation(3, false)
                })
                .wait(200)
                .call(function() {
                    effectAnimation(0, false)
                })
            stage.addChild(showActions);
...

        {
            ...
            if (battlelogs[z + 3][0] === start.player && battlelogs[z + 4][0] === "Enemy" && stunned) {
                ...
                if (a === 0) {
                    ...
                    if (success) {
                        createjs.Tween.get(player2bar[0], {
                                loop: false
                            })
                            .wait(100)
                            .to({
                                w: battlelogs[z + 2] / start.o_c1_max[0] * 181
                            }, 2000);
                    }
                }
                else if (a === 1) {
                    ...
                    if (success) {
                        createjs.Tween.get(player2bar[1], {
                                loop: false
                            })
                            .wait(100)
                            .to({
                                w: battlelogs[z + 2] / start.o_c2_max[0] * 181
                            }, 2000);
                    }
                    ...
                    if (success) {
                        createjs.Tween.get(player2bar[2], {
                                loop: false
                            })
                            .wait(100)
                            .to({
                                w: battlelogs[z + 2] / start.o_c3_max[0] * 181
                            }, 2000);
                    }
                }
                ...
                if (a === 0) {
                    ...
                    if (success) {
                        createjs.Tween.get(player1bar[0], {
                                loop: false
                            })
                            .wait(100)
                            .to({
                                w: battlelogs[z + 2] / start.y_c1_max[0] * 181
                            }, 2000);
                    }
                }
                else if (a === 1) {
                    ...
                    console.log("This skill was successful: " + success);
                    if (success) {
                        createjs.Tween.get(player1bar[1], {
                                loop: false
                            })
                            .wait(100)
                            .to({
                                w: battlelogs[z + 2] / start.y_c2_max[0] * 181
                            }, 2000);
                    }
                }
                else if (a === 2) {
                    ...
                    console.log("This skill was successful: " + success);
                    if (success) {
                        createjs.Tween.get(player1bar[2], {
                                loop: false
                            })
                            .wait(100)
                            .to({
                                w: battlelogs[z + 2] / start.y_c3_max[0] * 181
                            }, 2000);
                    }
                }
...
console.log("Display: " + display);
            ...
            switch (display) {
                case "Strength":
                    ...
                    createjs.Tween.get(animation, {
                        ...
                        .to({
                            x: b - 23,
                            y: c - 15
                        }, 300, createjs.Ease.linear) //5
                        .to({
                            x: b - 43,
                            y: c - 35
                        }, 300, createjs.Ease.linear) //10
                        .to({
                            x: b - 38,
                            y: c + 5
                        }, 300, createjs.Ease.linear) //10
                    ...
                    createjs.Sound.play("strengthsound", {
                        loop: 1,
                        volume: 0.01
                    });
                    break;
                ...
                case "Power-Up":
                    ...
                    createjs.Tween.get(animation, {
                        ...
                        .call(nextTurnAnimation)
                    createjs.Sound.play("powerdownsound", {
                        loop: 1,
                        volume: 0.01
                    });
                    break;
                ...
                case "Affliction":
                    ...
                    createjs.Tween.get(animation, {
                        ...
                        .to({
                            x: b,
                            y: c - 5
                        }, 1400, createjs.Ease.linear) //5
                        .to({
                            alpha: 0
                        }, 200, createjs.Ease.linear) //5
                        .call(nextTurnAnimation)

                    createjs.Sound.play("Afflictionsound", {
                        loop: 1,
                        volume: 0.01
                    });
                    break;
                ...
                case "Defensive":
                    ...
                    createjs.Tween.get(animation, {
                        ...
                        .to({
                            x: b,
                            y: c - 5
                        }, 1100, createjs.Ease.linear) //5
                        .to({
                            alpha: 0
                        }, 200, createjs.Ease.linear) //5
                        .call(nextTurnAnimation)

                    createjs.Sound.play("defensesound", {
                        loop: 0,
                        volume: 0.01
                    });
                    break;
        ...
        if (num === 1) {
            ...
            createjs.Tween.get(animationDefense, {
                    loop: false
                })
                .to({
                    x: b,
            ...
            createjs.Sound.play("stunnedsound", {
                loop: 1,
                volume: 0.01
            });
    ...
    function nextTurnAnimation() {
        ...
        if (z < len) {
           ...
           var a =  skillList(start.o_c1_transformation,[0]);
            if (start.o_c1_transformation !== "none" && notTransformed[3]) {
                b = 75;
                c = 50;
                transformationEffect(a[11][0]);
            }
            a =  skillList(start.o_c2_transformation,[0]);
            if (start.o_c2_transformation !== "none" && notTransformed[4]) {
                b = 447;
                c = 50;
                transformationEffect(a[11][0]);
            }
            a =  skillList(start.o_c3_transformation,[0]);
            ...
            a =  skillList(start.y_c1_transformation,[0]);
            if (start.y_c1_transformation !== "none" && notTransformed[0]) {
                b = 75;
                c = 585;
                transformationEffect(a[11][0]);
            }
            a =  skillList(start.y_c2_transformation,[0]);
            if (start.y_c2_transformation !== "none" && notTransformed[1]) {
                b = 447;
                c = 585;
                transformationEffect(a[11][0]);
            }
            a =  skillList(start.y_c3_transformation,[0]);
    ...
    if (len === 0) {
        ...
        if (start.o_c1_transformation !== "none") {
            b = 75;
            c = 50;
            a =  skillList(start.o_c1_transformation,[0]);
            transformationEffect(a[11][0]);
        ...
        var i = 1,
            z = 0,
            len, n = 0,
            turn, current, skill, aN, spriteSheet, animation, animationDefense, zHold, notTransformed = [true, true, true, true, true, true];
    ...
    var a = skillList(start.y_c1_transformation,[0]);
    console.log("Transformation: " + start.y_c1_transformation);
    console.log(a);
    if (a[11][1]) {
    ...
    function battlelog() {
        ...
        createjs.Tween.get(player1bar[0], {
            ...
            .to({
                w: start.y_c1_health / start.y_c1_max[0] * 181
            }, 2000);
        ...
        createjs.Tween.get(player1bar[1], {
            ...
            .to({
                w: start.y_c2_health / start.y_c2_max[0] * 181
            }, 2000);
        ...
        createjs.Tween.get(player1bar[2], {
            ...
            .to({
                w: start.y_c3_health / start.y_c3_max[0] * 181
            }, 2000);
        ...
        createjs.Tween.get(player2bar[0], {
            ...
            .to({
                w: start.o_c1_health / start.o_c1_max[0] * 181
            }, 2000);
        ...
        createjs.Tween.get(player2bar[1], {
            ...
            .to({
                w: start.o_c2_health / start.o_c2_max[0] * 181
            }, 2000);
        createjs.Tween.get(player2bar[2], {
                loop: false
            })
            .to({
                w: start.o_c3_health / start.o_c3_max[0] * 181
            }, 2000);

        player1CharacterSlot1.addEventListener("click", function() {
            p1CharacterSelected(1, p1character1.c);
        });
        player1CharacterSlot2.addEventListener("click", function() {
            p1CharacterSelected(2, p1character2.c);
        });
        player1CharacterSlot3.addEventListener("click", function() {
            p1CharacterSelected(3, p1character3.c);
        });

        player2CharacterSlot1.addEventListener("click", function() {
            p2CharacterSelected(1, moo.team[0]);
        });
        player2CharacterSlot2.addEventListener("click", function() {
            p2CharacterSelected(2, moo.team[1]);
        });
        player2CharacterSlot3.addEventListener("click", function() {
            p2CharacterSelected(3, moo.team[2]);
        });
        ...
        //Links
        P1BlinkingBox1.addEventListener("click", function() {
            blinkingEffect(1);
        });
        P1BlinkingBox2.addEventListener("click", function() {
            blinkingEffect(2);
        });
        P1BlinkingBox3.addEventListener("click", function() {
            blinkingEffect(3);
        });
        P2BlinkingBox1.addEventListener("click", function() {
            blinkingEffect(4);
        });
        P2BlinkingBox2.addEventListener("click", function() {
            blinkingEffect(5);
        });
        P2BlinkingBox3.addEventListener("click", function() {
            blinkingEffect(6);
        });
            ...
            if (a[i] === 0) {
                ...
                if (success) {
                    createjs.Tween.get(player2bar[0], {
                        ...
                        .wait(100)
                        .to({
                            w: battlelogs[z + 2][i] / start.o_c1_max[0] * 181
                        }, 2000);
                }
                ...
                if (success) {
                    createjs.Tween.get(player2bar[1], {
                        ...
                        .wait(100)
                        .to({
                            w: battlelogs[z + 2][i] / start.o_c2_max[0] * 181
                        }, 2000);
                }
                ...
                if (success) {
                    createjs.Tween.get(player2bar[2], {
                        ...
                        .wait(100)
                        .to({
                            w: battlelogs[z + 2][i] / start.o_c3_max[0] * 181
                        }, 2000);
                }
            ...
            if (a[i] === 0) {
                ...
                if (success) {
                    createjs.Tween.get(player1bar[0], {
                        ...
                        .wait(100)
                        .to({
                            w: battlelogs[z + 2][i] / start.y_c1_max[0] * 181
                        }, 2000);
                }
            }
            else if (a[i] === 1) {
                ...
                if (success) {
                    createjs.Tween.get(player1bar[1], {
                        ...
                        .wait(100)
                        .to({
                            w: battlelogs[z + 2][i] / start.y_c2_max[0] * 181
                        }, 2000);
                }
            }
            else if (a[i] === 2) {
                ...
                if (success) {
                    createjs.Tween.get(player1bar[2], {
                        ...
                        .wait(100)
                        .to({
                            w: battlelogs[z + 2][i] / start.y_c3_max[0] * 181
                        }, 2000);
                }
            }
    ...
    function p1CharacterSelected(num1, num2) {
        ...
        switch (num1) {
            case 1:
                createjs.Tween.get(statsStrength, {
                        loop: false
                    })
                    .to({
                        w: start.y_c1_strength / 150 * 200
                    }, 1000);

                createjs.Tween.get(statsSpeed, {
                        loop: false
                    })
                    .to({
                        w: start.y_c1_speed / 150 * 200
                    }, 1000);

                createjs.Tween.get(statsKi, {
                        loop: false
                    })
                    .to({
                        w: start.y_c1_ki / 150 * 200
                    }, 1000);

                createjs.Tween.get(statsDefense, {
                        loop: false
                    })
                    .to({
                        w: start.y_c1_defense / 150 * 200
                    }, 1000);
        ...
        if (dummy.conditions[1] != 0) {
            effects_current = effects_current + "This character cannot be killed.\n";
        }
        if (dummy.conditions[2] != 0) {
            effects_current = effects_current + "This character cooldowns are increased by 2 for " + dummy.conditions[2] + " turn(s).\n";
        }
        if (dummy.conditions[3] != 0) {
            effects_current = effects_current + "This character can't be healed for " + dummy.conditions[3] + " turn(s).\n";
        }
    ...
    function skillUpdate(num1, num3) {
        ...
        switch (stype) {
            ...
            case "Power-Down":
                ...
                if (start.o_c1_block[0] === 0 && start.o_c1_block[3] === 0) {
                    block1 = false;
                }
                else {
                    block1 = true;
                }
                if (start.o_c2_block[0] === 0 && start.o_c2_block[3] === 0) {
                    block2 = false;
                }
                else {
                    block2 = true;
                }
                if (start.o_c3_block[0] === 0 && start.o_c3_block[3] === 0) {
                    block3 = false;
                }
                else {
                    block3 = true;
    ...
    function blinkingEffect(num1) {
        ...
        if (focus === 2) {
            ...
            if (send[0] > -1) {
                p2Ch1boxes[send[0]].addEventListener("click", function() {
                    cancel(7, send, c, gain);
                });

            }
            if (send[1] > -1) {
                p2Ch2boxes[send[1]].addEventListener("click", function() {
                    cancel(7, send, c, gain);
                });

            }
            if (send[2] > -1) {
                p2Ch3boxes[send[2]].addEventListener("click", function() {
                    cancel(7, send, c, gain);
                });
            ...
            if (send[0] > -1) {
                p1Ch1boxes[send[0]].addEventListener("click", function() {
                    cancel(8, send, c, gain);
                });
            }
            if (send[1] > -1) {
                p1Ch2boxes[send[1]].addEventListener("click", function() {
                    cancel(8, send, c, gain);
                });
            }
            if (send[2] > -1) {
                p1Ch3boxes[send[2]].addEventListener("click", function() {
                    cancel(8, send, c, gain);
                });
            }
            ...
            if (moveNow !== 0 && num1 === 1) {
                ...
                switch (c) {
                    case 1:
                        ...
                        p1Ch1boxes[0].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch1boxes[0]);
                        p1Ch1boxes[0].addEventListener("click", function() {
                            cancel(num1, 0, c, gain);
                        });
                        break;
                    ...
                    case 2:
                        ...
                        p1Ch1boxes[1].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch1boxes[1]);
                        p1Ch1boxes[1].addEventListener("click", function() {
                            cancel(num1, 1, c, gain);
                        });
                        break;
                    ...
                    case 3:
                        ...
                        p1Ch1boxes[2].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch1boxes[2]);
                        p1Ch1boxes[2].addEventListener("click", function() {
                            cancel(num1, 2, c, gain);
                        });
                        break;
                ...
                switch (c) {
                    case 1:
                        ...
                        p1Ch2boxes[0].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch2boxes[0]);
                        p1Ch2boxes[0].addEventListener("click", function() {
                            cancel(num1, 0, c, gain);
                        });
                        break;
                    ...
                    case 2:
                        ...
                        p1Ch2boxes[1].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch2boxes[1]);
                        p1Ch2boxes[1].addEventListener("click", function() {
                            cancel(num1, 1, c, gain);
                        });
                        break;
                    ...
                    case 3:
                        ...
                        p1Ch2boxes[2].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch2boxes[2]);
                        p1Ch2boxes[2].addEventListener("click", function() {
                            cancel(num1, 2, c, gain);
                        });
                        break;
                }
                ...
                switch (c) {
                    case 1:
                        ...
                        p1Ch3boxes[0].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch3boxes[0]);
                        p1Ch3boxes[0].addEventListener("click", function() {
                            cancel(num1, 0, c, gain);
                        });
                        break;
                    ...
                    case 2:
                        ...
                        p1Ch3boxes[1].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch3boxes[1]);
                        p1Ch3boxes[1].addEventListener("click", function() {
                            cancel(num1, 1, c, gain);
                        });
                        break;
                    ...
                    case 3:
                        ...
                        p1Ch3boxes[2].image = queue.getResult(moveNow);
                        stage.addChild(p1Ch3boxes[2]);
                        p1Ch3boxes[2].addEventListener("click", function() {
                            cancel(num1, 2, c, gain);
                        });
                        break;
                }
                ...
                switch (c) {
                    case 1:
                        ...
                        p2Ch1boxes[0].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch1boxes[0]);
                        p2Ch1boxes[0].addEventListener("click", function() {
                            cancel(num1, 0, c, gain);
                        });
                        break;
                    ...
                    case 2:
                        ...
                        p2Ch1boxes[1].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch1boxes[1]);
                        p2Ch1boxes[1].addEventListener("click", function() {
                            cancel(num1, 1, c, gain);
                        });
                        break;
                    ...
                    case 3:
                        ...
                        p2Ch1boxes[2].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch1boxes[2]);
                        p2Ch1boxes[2].addEventListener("click", function() {
                            cancel(num1, 2, c, gain);
                        });
                        break;
                }
                ...
                switch (c) {
                    case 1:
                        ...
                        p2Ch2boxes[0].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch2boxes[0]);
                        p2Ch2boxes[0].addEventListener("click", function() {
                            cancel(num1, 0, c, gain);
                        });
                        break;
                    ...
                    case 2:
                        ...
                        p2Ch2boxes[1].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch2boxes[1]);
                        p2Ch2boxes[1].addEventListener("click", function() {
                            cancel(num1, 1, c, gain);
                        });
                        break;
                    ...
                    case 3:
                        ...
                        p2Ch2boxes[2].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch2boxes[2]);
                        p2Ch2boxes[2].addEventListener("click", function() {
                            cancel(num1, 2, c, gain);
                        });
                        break;
                ...
                switch (c) {
                    case 1:
                        ...
                        p2Ch3boxes[0].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch3boxes[0]);
                        p2Ch3boxes[0].addEventListener("click", function() {
                            cancel(num1, 0, c, gain);
                        });
                        break;
                    ...
                    case 2:
                        ...
                        p2Ch3boxes[1].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch3boxes[1]);
                        p2Ch3boxes[1].addEventListener("click", function() {
                            cancel(num1, 1, c, gain);
                        });
                        break;
                    ...
                    case 3:
                        ...
                        p2Ch3boxes[2].image = queue.getResult(moveNow);
                        stage.addChild(p2Ch3boxes[2]);
                        p2Ch3boxes[2].addEventListener("click", function() {
                            cancel(num1, 2, c, gain);
                        });
                        break;
                }
        ...
        if (num === 1) {
            ...
            switch (p1character1.cooldown[0]) {
                case 0:
                    ...
                    skills1.addEventListener("click", function() {
                        skillSelected(1, 1, p1character1.skills[0], true);
                    });
                    break;
            ...
            switch (p1character1.cooldown[1]) {
                case 0:
                    ...
                    skills2.addEventListener("click", function() {
                        skillSelected(1, 2, p1character1.skills[1], true);
                    });
                    break;
            ...
            switch (p1character1.cooldown[2]) {
                case 0:
                    skills3.addEventListener("click", function() {
                        skillSelected(1, 3, p1character1.skills[2], true);
                    });
                    break;
            ...
            switch (p1character1.cooldown[3]) {
                case 0:
                    skills4.addEventListener("click", function() {
                        skillSelected(1, 4, p1character1.skills[3], true);
                    });
                    break;
            ...
            switch (p1character1.cooldown[4]) {
                case 0:
                    skills5.addEventListener("click", function() {
                        skillSelected(1, 5, p1character1.skills[4], true);
                    });
                    break;
            ...
            switch (p1character2.cooldown[0]) {
                case 0:
                    ...
                    skills1.addEventListener("click", function() {
                        skillSelected(2, 1, p1character2.skills[0], true);
                    });
                    break;
            ...
            switch (p1character2.cooldown[1]) {
                case 0:
                    ...
                    skills2.addEventListener("click", function() {
                        skillSelected(2, 2, p1character2.skills[1], true);
                    });
                    break;
            ...
            switch (p1character2.cooldown[2]) {
                case 0:
                    skills3.addEventListener("click", function() {
                        skillSelected(2, 3, p1character2.skills[2], true);
                    });
                    break;
            ...
            switch (p1character2.cooldown[3]) {
                case 0:
                    skills4.addEventListener("click", function() {
                        skillSelected(2, 4, p1character2.skills[3], true);
                    });
                    break;
            ...
            switch (p1character2.cooldown[4]) {
                case 0:
                    skills5.addEventListener("click", function() {
                        skillSelected(2, 5, p1character2.skills[4], true);
                    });
                    break;
            ...
            switch (p1character3.cooldown[0]) {
                case 0:
                    skills1.addEventListener("click", function() {
                        skillSelected(3, 1, p1character3.skills[0], true);
                    });
                    break;
            ...
            switch (p1character3.cooldown[1]) {
                case 0:
                    skills2.addEventListener("click", function() {
                        skillSelected(3, 2, p1character3.skills[1], true);
                    });
                    break;
            ...
            switch (p1character3.cooldown[2]) {
                case 0:
                    skills3.addEventListener("click", function() {
                        skillSelected(3, 3, p1character3.skills[2], true);
                    });
                    break;
            ...
            switch (p1character3.cooldown[3]) {
                case 0:
                    skills4.addEventListener("click", function() {
                        skillSelected(3, 4, p1character3.skills[3], true);
                    });
                    break;
            ...
            switch (p1character3.cooldown[4]) {
                case 0:
                    skills5.addEventListener("click", function() {
                        skillSelected(3, 5, p1character3.skills[4], true);
                    });
                    break;
            ...
            skills1.addEventListener("click", function() {
                skillSelected(1, 1, start.o_c1_skillhold[0], false);
            });
            skills2.addEventListener("click", function() {
                skillSelected(1, 2, start.o_c1_skillhold[1], false);
            });
            skills3.addEventListener("click", function() {
                skillSelected(1, 3, start.o_c1_skillhold[2], false);
            });
            skills4.addEventListener("click", function() {
                skillSelected(1, 4, start.o_c1_skillhold[3], false);
            });
            skills5.addEventListener("click", function() {
                skillSelected(1, 5, start.o_c1_skillhold[4], false);
            });
            ...
            skills1.addEventListener("click", function() {
                skillSelected(2, 1, start.o_c2_skillhold[0], false);
            });
            skills2.addEventListener("click", function() {
                skillSelected(2, 2, start.o_c2_skillhold[1], false);
            });
            skills3.addEventListener("click", function() {
                skillSelected(2, 3, start.o_c2_skillhold[2], false);
            });
            skills4.addEventListener("click", function() {
                skillSelected(2, 4, start.o_c2_skillhold[3], false);
            });
            skills5.addEventListener("click", function() {
                skillSelected(2, 5, start.o_c2_skillhold[4], false);
            });
        }
            ...
            skills1.addEventListener("click", function() {
                skillSelected(3, 1, start.o_c3_skillhold[0], false);
            });
            skills2.addEventListener("click", function() {
                skillSelected(3, 2, start.o_c3_skillhold[1], false);
            });
            skills3.addEventListener("click", function() {
                skillSelected(3, 3, start.o_c3_skillhold[2], false);
            });
            skills4.addEventListener("click", function() {
                skillSelected(3, 4, start.o_c3_skillhold[3], false);
            });
            skills5.addEventListener("click", function() {
                skillSelected(3, 5, start.o_c3_skillhold[4], false);
            });
        }
    ...
    function battleEnd() {
        ...
        var file = {
            action: "attack",
            m1: p1character1.moveUsed,
            m2: p1character2.moveUsed,
            m3: p1character3.moveUsed,
            target1: p1character1.targeted,
            target2: p1character2.targeted,
            target3: p1character3.targeted,
            target4: p1.targeted,
            ms1: p1character1.mu,
            ms2: p1character2.mu,
            ms3: p1character3.mu,
...
console.log(type);
    ...
    function cancelSociety() {
        // createjs.Sound.play("select", {loop: 0,volume:0.1});
            ...
            stage.removeChild(info);
            var bye = {
                action: "cancel_society"
            };
            ws.send(JSON.stringify(bye));
            dragonverseOpen();
             console.log("Here Cone: Fix");
...
function newItem(num) {
    ...
    $("#itemConditionShop").text("Cooldown:" + f[2] + " BP:" + f[3] + " Type:" + f[4] + " Limit:" + f[6]);
    if (skill[0] === "c") {
...
var gamemode= new createjs.Bitmap(queue.getResult("gamemode"));
gamemode.x = 300;
gamemode.y = 130;
stage.addChild(gamemode);

var rank = new createjs.Shape();
        rank.graphics.beginFill("black").drawRect(313, 170, 540, 160);
        rank.alpha = 0.01;
        rank.cursor = "pointer";
        rank.addEventListener("click", rankMatch);
        stage.addChild(rank);
        
var privatecover = new createjs.Shape();
        privatecover.graphics.beginFill("black").drawRect(313, 330, 540, 160);
        privatecover.alpha = 0.01;
        privatecover.cursor = "pointer";
        privatecover.addEventListener("click", privateMatch);
        stage.addChild(privatecover);

var X = new createjs.Bitmap(queue.getResult("x"));
X.x = 820;
X.y = 100;
X.cursor = "pointer";
X.addEventListener("click", removeMatch);
stage.addChild(X);

function removeMatch()
{
   stage.removeChild(endTurnImage);
   stage.removeChild(gamemode);
   privatecover.removeEventListener("click", privateMatch);
   rank.removeEventListener("click", rankMatch);
   X.removeEventListener("click", removeMatch);
   stage.removeChild(X);
    createjs.Sound.play("select", {
        loop: 0,
        volume: 0.1
...
function tutorial(num)
{
    ...
    {
        case 0:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial0.png' class='center-block img-responsive'><div class='shadow7'>You have entered the game's client. This is a quick tutorial covering the main menu.</div><button class='button2 btn-block' onclick='tutorial(1);'>Next</button>");
        break;
        
        case 1:
         $("#tutorialPost").empty().append(" <img src='/assets/tutorial1.png' class='center-block img-responsive'><div class='shadow7'>This is Capsule Corp. Capsule Corp is where you buy items, skills, and characters. In order to buy these things you will need Zennie, which is earned through the Dragon Quest.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(0);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(2);'>Next</button></div>");
        break;
        
        case 2:
         $("#tutorialPost").empty().append(" <img src='/assets/tutorial2.png' class='center-block img-responsive'><div class='shadow7'>This is Team Builder. Team builder is where you manage your team for battle. You can select the characters and items you want to use in battle.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(1);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(3);'>Next</button></div>");
        break;
        
        case 3:
         $("#tutorialPost").empty().append(" <img src='/assets/tutorial3.png' class='center-block img-responsive'><div class='shadow7'>This is Inventory. Inventory displays all the skills and characters you have unlocked and haven't unlocked. You can also convert duplicates of skills and characters for Kili. Kili can be used to craft new skills and characters.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(2);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(4);'>Next</button></div>");
        break;
        
        case 4:
         $("#tutorialPost").empty().append(" <img src='/assets/tutorial4.png' class='center-block img-responsive'><div class='shadow7'>This is Shenron. After you have collected all seven dragon balls you are allowed one wish. This feature will be available soon. </div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(3);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(5);'>Next</button></div>");
        break;
        
        case 5:
         $("#tutorialPost").empty().append(" <img src='/assets/tutorial5.png' class='center-block img-responsive'><div class='shadow7'>This is Dragonverse. To battle in this game to must first join a society in Dragonverse. Ranked and private matches becomes available after completing the society process. </div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(4);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(6);'>Next</button></div>");
        break;
        
        case 6:
         $("#tutorialPost").empty().append(" <img src='/assets/tutorial0.png' class='center-block img-responsive'><div class='shadow7'>You have completed the main menu's tutorial. For further help please visit our <a href='/forums' target='_blank'>forum</a> or <a href='https://discord.gg/VHb2DVt' target='_blank'>discord</a>. Have fun playing the game!</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(5);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(7);'>Next</button></div>");
        break;
        ...
        case 8:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial6.png' class='center-block img-responsive'><div class='shadow7'>Welcome to Capsule Corp. This is a quick tutorial convering Capsule Corp.</div><button class='button2 btn-block' onclick='tutorial(9);'>Next</button>");
        break;
        
        case 9:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial7.png' class='center-block img-responsive'><div class='shadow7'>In Capsule Corp there is an event banner that tells you which characters and skills have boosted rates to pull from rolling.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(8);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(10);'>Next</button></div>");
        break;
        
        case 10:
         $("#tutorialPost").empty().append(" <img src='/assets/tutorial8.png' class='center-block img-responsive'><div class='shadow7'>Clicking on the skill single/multi roll button rewards you with skills by using a certain amount of zennie that is displayed on the button.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(9);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(11);'>Next</button></div>");    
        break;
        
        case 11:
         $("#tutorialPost").empty().append(" <img src='/assets/tutorial9.png' class='center-block img-responsive'><div class='shadow7'>Clicking on the character single/multi roll button rewards you with characters by using a certain amount of zennie which is displayed on the button.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(10);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(12);'>Next</button></div>");    
        break;
        
        case 12:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial10.png' class='center-block img-responsive'><div class='shadow7'>Clicking on the capsule image allows you to buy new items which can help you create new strategies. Items also cost zennie to buy.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(11);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(13);'>Next</button></div>");    
        break;
        
        case 13:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial11.png' class='center-block img-responsive'><div class='shadow7'>Your available Zennie can be viewed at the top of Capsule Corp. To earn more Zennie you need to win games and complete daily quests in the Dragonverse.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(12);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(14);'>Next</button></div>");        
        break;
        
        case 14:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial6.png' class='center-block img-responsive'><div class='shadow7'>You have completed the Capsule Corps tutorial. Enjoy buying new skills, characters, and items. For further help please visit our <a href='/forums' target='_blank'>forum</a> or <a href='https://discord.gg/VHb2DVt' target='_blank'>discord</a>. Have fun playing the game!</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(13);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(15);'>Next</button></div>");        
        break;
        ...
        case 16:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial12.png' class='center-block img-responsive'><div class='shadow7'>Welcome to Team Builder. This is a quick tutorial covering Team Builder.</div><button class='button2 btn-block' onclick='tutorial(17);'>Next</button>");    
        break;
        
        case 17:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial13.png' class='center-block img-responsive'><div class='shadow7'>This shows your current team. By clicking a character on your team you can change the character to your desire. When changing a character it will give generic skills by default, so make sure to change them if you don't want to use only generic skills. </div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(16);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(18);'>Next</button></div>");    
        break;
        
        case 18:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial14.png' class='center-block img-responsive'><div class='shadow7'>This shows the skills of the character you hover over. By clicking one of skills you can change the skill to your desire. When changing a character it will give generic skills by default, so make sure to change them if you don't want to use only generic skills.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(17);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(19);'>Next</button></div>");    
        break;
        
        case 19:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial15.png' class='center-block img-responsive'><div class='shadow7'>Skill Selection allows you to select the skill you want to swap out. You can view all details relating to skill at the top of the swap panel.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(18);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(20);'>Next</button></div>");    
        break;
        
        case 20:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial16.png' class='center-block img-responsive'><div class='shadow7'>Character Selection allows you to select the character you want to swap out. You can view all details relating to the character at the top of the swap panel.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(19);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(21);'>Next</button></div>");     
        break;
        
        case 21:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial18.png' class='center-block img-responsive'><div class='shadow7'>By clicking on the Capsule image you are able to change your items.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(20);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(22);'>Next</button></div>");     
        break;
        
        case 22:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial19.png' class='center-block img-responsive'><div class='shadow7'>By clicking the save button you are able to save changes you made to your team. If you forget to save after changing your team, it will automatically save changes for you.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(21);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(23);'>Next</button></div>");     
        break;
        
        case 23:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial20.png' class='center-block img-responsive'><div class='shadow7'>This is the preset team area. You can create a team and save it to the preset teams in case you're planning to use it for something else.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(22);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(24);'>Next</button></div>");     
        break;
        
        case 24:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial12.png' class='center-block img-responsive'><div class='shadow7'>You have completed the Team Builder tutorial. Enjoy creating new teams and strategies. For further help please visit our <a href='/forums' target='_blank'>forum</a> or <a href='https://discord.gg/VHb2DVt' target='_blank'>discord</a>. Have fun playing game!</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(23);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(25);'>Next</button></div>");     
        break;
       ...
       $("#tutorial").modal("hide");  
        ...
        case 26:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial20.png' class='center-block img-responsive'><div class='shadow7'>Welcome to Inventory. This is a quick tutorial covering Inventory.</div><button class='button2 btn-block' onclick='tutorial(27);'>Next</button>");    
        break;
        
        case 27:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial24.png' class='center-block img-responsive'><div class='shadow7'>The unlocked button shows you all characters and skills you have unlocked in the game. The locked button shows you all characters and skills you haven't unlocked in the game.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(26);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(28);'>Next</button></div>");    
        break;
        
        case 28:
        $("#tutorialPost").empty().append(" <img src='/assets/tutorial21.png' class='center-block img-responsive'><div class='shadow7'>The characters button shows only characters while the skills button shows only skills. The blue button displays all unlocked characters and skills. The red button displays all characters and skills you haven't unlocked. </div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(27);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(29);'>Next</button></div>");    
        break;
        
        case 29:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial22.png' class='center-block img-responsive'><div class='shadow7'>This is the display area for characters and skills. In Unlocked Mode, you can see how many of any character or skill you have by clicking on the character or skill.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(28);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(30);'>Next</button></div>");    
        break;
        
        case 30:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial23.png' class='center-block img-responsive'><div class='shadow7'>The left will display what you currently clicked on and the number in the box tells how many of any character or skill you have. The box on the right tells you how much Kili you have. Kili is used to craft new characters and skills you don't already have.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(29);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(31);'>Next</button></div>");     
        break;
        
        case 31:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial25.png' class='center-block img-responsive'><div class='shadow7'>When in Unlocked Mode, you can click on a character or skill which can then be converted to Kili using the Convert icon. This option allows you to scrap duplicates and get Kili in return. </div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(30);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(32);'>Next</button></div>");     
        break;
        
        case 32:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial26.png' class='center-block img-responsive'><div class='shadow7'>When in Locked Mode, you can click on a character or skill and craft them for new characters and skills for a certain amount of Kili. </div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(31);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(33);'>Next</button></div>");     
        break;
        
        case 33:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial27.png' class='center-block img-responsive'><div class='shadow7'>Here you can either accept that you want to convert/craft or cancel. The number in the middle tells you the amount of Kili you get from Unlocked Mode or the cost to craft in Locked Mode.</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(32);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(34);'>Next</button></div>");     
        break;
        
        case 34:
       $("#tutorialPost").empty().append(" <img src='/assets/tutorial20.png' class='center-block img-responsive'><div class='shadow7'>You have completed the Inventory tutorial. Enjoy crafting and converting characters and skills. For further help please visit our <a href='/forums' target='_blank'>forum</a> or <a href='https://discord.gg/VHb2DVt' target='_blank'>discord</a>. Enjoy playing the game!</div><div class='row'><button class='button2 col-lg-6' onclick='tutorial(33);'>Previous</button><button class='button2 col-lg-6' onclick='tutorial(35);'>Next</button></div>");     
        break;
